...
// --- 1. CONFIGURATION ---
const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzNYmkUwkr67DZ__KG4cRC1npjUJJ1q2zWqTz4iaTw0QN3w2smlmmh-HH44zdS-B_bY/exec"; 
...
function calculateTotal() {
    ...
    document.querySelectorAll('.bk-addon:checked').forEach(chk => {
        ...
        if(chk.value.includes("50")) price += 50;
...
${msgPay} Terima kasih!`;
        ...
        window.location.href = `https://wa.me/601111994521?text=${encodeURIComponent(waMsg)}`;
    }).catch(e => {
        window.location.href = "https://wa.me/601111994521"; 
    });
}
